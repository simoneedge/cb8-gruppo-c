    ...
    <div>
      <section id="our-app">
        ...
        <p>
          ...
          Just Play, una web app pensata per gli amanti dello sport. Con
          tecnologie all&apos;avanguardia come Next.js, React.js, MongoDB e
          Sass, Just Play semplifica l&apos;organizzazione di partite nei campi
          reali della tua città, consentendoti di selezionare il tuo sport
          preferito con facilità. Che tu sia un appassionato di calcio, basket,
          tennis o altro, Just Play ti mette in contatto con altri giocatori,
          offrendoti un&apos;esperienza sociale coinvolgente e divertente.
          Grazie alla sua autenticazione integrata, puoi personalizzare il tuo
          profilo e gestire la tua lista amici per una connessione ancora più
          profonda con la community Just Play. E non finisce qui: alla fine di
          ogni match, il nostro sistema di rating valuta il fair play, la
          puntualità e l&apos;abilità, garantendo un ambiente sportivo positivo
